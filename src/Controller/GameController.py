...
#---------------------# HIDE BUTTONS AND IMAGES #---------------------#
    ...
    def hide_hint(self, hint_IDs):
        self.gui.gameplay_frame.hide_hint(self.gui.game_canvas, hint_IDs)
...
#---------------------# EDIT GAMEBOARD BUTTON FUNCTIONALITY #---------------------#
...
#---------------------# SAVE BOARD BUTTON FUNCTIONALITY #---------------------#
